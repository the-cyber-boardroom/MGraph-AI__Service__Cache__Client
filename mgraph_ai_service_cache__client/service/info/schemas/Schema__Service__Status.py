...
from mgraph_ai_service_cache__client.service.info.schemas.Enum__Service_Environment  import Enum__Service_Environment
...
class Schema__Service__Status(Type_Safe):
    ...
    version     : Safe_Str__Version         = version__mgraph_ai_service_cache__client
