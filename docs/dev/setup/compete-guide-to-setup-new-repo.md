...
mv mgraph_ai_service_cache__client mgraph_ai_service_graphs
```
...
1. **Replace "MGraph AI Service Cache Client"** → **"MGraph-AI Service Graphs"**
   - Should find ~10 occurrences
   - These are in documentation and comments

2. **Replace "mgraph_ai_service_cache__client"** → **"mgraph_ai_service_graphs"**
   - Should find 1-2 occurrences (after rename script)
   - This is the Python package name

3. **Replace "MGraph-AI__Service__Cache__Client"** → **"MGraph-AI__Service__Graphs"**
