...
git remote add template https://github.com/org/MGraph-AI__Service__Cache__Client.git
```
...
git fetch template
git checkout template/main -- mgraph_ai_service_cache__client/routes/health.py
