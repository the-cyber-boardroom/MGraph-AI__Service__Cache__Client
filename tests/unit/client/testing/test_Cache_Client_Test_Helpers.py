...
class test_Cache_Client_Test_Helpers(TestCase):                         # Test the test helpers class itself
    ...
    def test__bug__create_binary_entry__defaults(self):      # Test creating binary entry with defaults
        ...
        assert result.obj() == __( cache_id   = __SKIP__,       # BUG (if we got an id for a file not created
                                   cache_hash = ''  ,           # BUG
                                   namespace  = ''  ,           # BUG
                                   paths      = __(),           # BUG
                                   size       = 0   )
        ...
        assert is_guid(result.cache_id)    is True
        #assert result.namespace            == 'test'
        assert result.namespace            == ''        # BUG
        assert result.size                 ==  0        # BUG

    def test__create_binary_entry__custom_data(self):
        """Test creating binary entry with custom data"""
        ...
        retrieved = self.client_cache_service.retrieve().retrieve__cache_id__binary(
            cache_id  = cache_id  ,
            namespace = namespace
        )
    ...
    def test__create_binary_entry__large_data(self):
        """Test creating binary entry with large data"""
    ...
    def test__add_data_string__auto_generated_id(self):
        ...
        assert type(data_result)              is dict
    ...
    def test__add_data_string__custom_file_id(self):
        """Test adding string data file with custom file_id"""
        # Setup
        namespace    = 'test-helpers-add-string-id'
        main_entry   = self.helpers.create_string_entry(namespace=namespace)
        cache_id     = main_entry['cache_id']

        # Action: Add with custom ID
        data_file_id = 'my-custom-data-id'
        data_result  = self.helpers.add_data_string(cache_id     = cache_id     ,
                                                    namespace    = namespace    ,
    ...
    def test__add_data_string__with_key_and_id(self):
        """Test adding string data file with data_key and file_id"""
        # Setup
    ...
    def test__add_data_json__auto_generated_id(self):
        """Test adding JSON data file with auto-generated ID"""
        # Setup
        ...
        # Verify
        assert data_result['data_type']       == 'json'
        assert data_result['extension']       == 'json'
        assert is_guid(data_result['file_id']) is True

    def test__add_data_json__custom_file_id(self):
        """Test adding JSON data file with custom file_id"""
        # Setup
    ...
    def test__add_data_json__with_key_and_id(self):
        """Test adding JSON data file with key and ID"""
        # Setup
    ...
    def test__add_data_binary__auto_generated_id(self):
        """Test adding binary data file with auto-generated ID"""
        # Setup
        ...
        # Verify
        assert data_result['data_type']       == 'binary'
        assert data_result['extension']       == 'bin'
        assert data_result['file_size']       == len(custom_data)
        assert is_guid(data_result['file_id']) is True

    def test__add_data_binary__custom_file_id(self):
        """Test adding binary data file with custom file_id"""
        # Setup
    ...
    def test__add_data_binary__with_key_and_id(self):
        """Test adding binary data file with key and ID"""
        # Setup
    ...
    def test__create_entry_with_data_files__default_counts(self):
        """Test creating entry with default data file counts"""
        namespace = 'test-helpers-with-data'

        # Action: Create entry with data files (default: 2 string, 2 json, 1 binary)
        cache_id, store_result = self.helpers.create_entry_with_data_files(namespace=namespace)
        ...
        # NOTE: Can't easily count without admin access or list method
        # But we can verify the helper returned valid data
        assert cache_id                       is not None

    def test__create_entry_with_data_files__custom_counts(self):
        """Test creating entry with custom data file counts"""
        namespace = 'test-helpers-with-data-custom'

        # Action: Custom counts
        cache_id, store_result = self.helpers.create_entry_with_data_files(
            namespace    = namespace ,
            string_count = 5        ,
            json_count   = 3        ,
            binary_count = 2
    ...
    def test__create_entry_with_data_files__with_keys(self):
        """Test creating entry with data files using key paths"""
    ...
    def test__verify_entry_exists__existing_entry(self):
        """Test verifying an existing entry"""
        # Setup: Create entry
    ...
    def test__verify_entry_exists__non_existent_entry(self):
    ...
    def test__verify_entry_exists_by_hash__existing(self):
        """Test verifying entry by hash - existing"""
        # Setup: Create entry
    ...
    def test__verify_entry_exists_by_hash__non_existent(self):
        """Test verifying entry by hash - non-existent"""
    ...
    def test__verify_data_file_exists__existing(self):
        """Test verifying data file exists - existing"""
    ...
    def test__verify_data_file_exists__non_existent(self):
        """Test verifying data file exists - non-existent"""
        # Setup: Create entry WITHOUT data files
        namespace = 'test-helpers-verify-data-not-exists'
        result    = self.helpers.create_string_entry(namespace=namespace)
        cache_id  = result['cache_id']
    ...
    def test__get_all_namespaces__after_creating_entries(self):
        """Test getting all namespaces after creating entries"""
    ...
    def test__create_multi_strategy_entries__all_strategies(self):
        """Test creating entries with all storage strategies"""
    ...
    def test__create_versioned_entries__default_count(self):
        """Test creating versioned entries with default count"""
    ...
    def test__create_namespace_hierarchy__default_depth(self):
        """Test creating namespace hierarchy with default depth"""
    ...
    def test__create_namespace_hierarchy__custom_params(self):
        """Test creating namespace hierarchy with custom parameters"""
    ...
    def test__delete_entry__successful(self):
        ...
        exists_before = self.helpers.verify_entry_exists(cache_id  = cache_id  ,
                                                        namespace = namespace )
        assert exists_before                  is True

        # Action: Delete
        delete_result = self.helpers.delete_entry(cache_id  = cache_id  ,
                                                 namespace = namespace )
        ...
        exists_after = self.helpers.verify_entry_exists(cache_id  = cache_id  ,
                                                       namespace = namespace )
        assert exists_after                   is False

    def test__delete_all_data_files__successful(self):
        """Test deleting all data files from entry"""
        ...
        assert type(delete_result)            is dict
        assert 'deleted_count'                in delete_result
        assert delete_result['deleted_count'] >= 3                              # At least 3 files deleted

    # ═════════════════════════════════════════════════════════════════════════════
    # Edge Cases and Error Scenarios
    # ═════════════════════════════════════════════════════════════════════════════

    def test__create_string_entry__empty_value(self):
        """Test creating entry with empty string value"""
        result = self.helpers.create_string_entry(value='')

        assert is_guid(result['cache_id'])    is True
        # Empty string should still store successfully

    def test__create_json_entry__empty_dict(self):
        """Test creating entry with empty JSON dict"""
        result = self.helpers.create_json_entry(data={})

        assert is_guid(result['cache_id'])    is True

    def test__create_binary_entry__empty_bytes(self):
        """Test creating entry with empty bytes"""
        result = self.helpers.create_binary_entry(data=b'')

        assert is_guid(result['cache_id'])    is True
        assert result['size']                 >= 0

    def test__add_data_string__none_value_uses_default(self):
        """Test that None data value uses auto-generated default"""
        # Setup
    ...
    def test__verify_methods__with_invalid_namespace(self):
        """Test verification methods with invalid namespace"""
    ...
    def test__integration__create_verify_delete_workflow(self):
        """Test complete workflow using multiple helper methods"""
        # Step 1: Create entry
        ...
        cache_id2, _ = self.helpers.create_entry_with_data_files(namespace    = namespace,
                                                                 string_count = 2       )
    ...
    def test__integration__multi_strategy_and_verification(self):
        """Test creating multi-strategy entries and verifying each"""
    ...
    def test__integration__versioned_entries_and_retrieval(self):
        """Test creating versioned entries and verifying all versions"""
...
# ═════════════════════════════════════════════════════════════════════════════════
"""
HELPER METHODS TESTED: 30+

✅ Initialization (2 tests)
✅ String entry creation (7 tests)
✅ JSON entry creation (4 tests)
✅ Binary entry creation (3 tests)
✅ Add data string (3 tests)
✅ Add data JSON (3 tests)
✅ Add data binary (3 tests)
✅ Create entry with data files (4 tests)
✅ Verification methods (6 tests)
✅ Multi-strategy entries (1 test)
✅ Versioned entries (2 tests)
✅ Namespace hierarchy (2 tests)
...
COVERAGE:
- All helper creation methods ✅
- All verification methods ✅
- All complex scenario builders ✅
- All cleanup methods ✅
- Edge cases ✅
- Integration workflows ✅

PATTERNS DEMONSTRATED:
- Testing test helpers (meta-testing)
- Verification using client methods only
- Edge case coverage
- Integration testing
