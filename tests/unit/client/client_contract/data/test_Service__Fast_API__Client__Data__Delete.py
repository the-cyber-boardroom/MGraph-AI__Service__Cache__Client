...
from mgraph_ai_service_cache_client.client.client_contract.data.Service__Fast_API__Client__Data__Delete     import Service__Fast_API__Client__Data__Delete
...
class test_Service__Fast_API__Client__Data__Delete(TestCase):
    ...
    def setUpClass(cls) -> None:                                                                            # Setup in-memory client
        ...
        cls.data_delete                             = cls.client_cache_service.data().delete()
    ...
    def test__setUpClass(self):                                                                             # Verify test setup
        with self.data_delete as _:
            assert type(_)         is Service__Fast_API__Client__Data__Delete
