...
from mgraph_ai_service_cache_client.client.client_contract.data.Service__Fast_API__Client__Data__List       import Service__Fast_API__Client__Data__List
...
class test_Service__Fast_API__Client__Data__List(TestCase):
    ...
    def setUpClass(cls) -> None:                                                                            # Setup in-memory client
        ...
        cls.data_list                               = cls.client_cache_service.data().list()
    ...
    def test__setUpClass(self):                                                                             # Verify test setup
        with self.data_list as _:
            assert type(_)         is Service__Fast_API__Client__Data__List
